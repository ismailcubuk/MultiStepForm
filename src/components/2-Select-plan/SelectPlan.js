...
function SelectPlan() {
    const { setPage, isChecked, handleCheckboxChange, arcadeMoney, advancedMoney, proMoney, moYr, ArcadeActive, AdvancedActive, ProActive, arcadeClick, AdvancedClick, ProClick, count, setCount, setPlan, plan, setDate, date } = useContext(FormContext)
    const nextClick = () => {
        setCount(count + 1)

...
function Summary() {
    const { setPage, money, moYr, tax, customProfileMoney, largerStorageMoney, onlineServiceMoney, count, setCount, date, onlineServiceActive, largerStorageActive, customProfileeActive } = useContext(FormContext)
    const nextClick = () => {
        setCount(count + 1)
            ...
            <div className='main'>
                ...
                <div className='summary'>
                    <div>
                        <div>
                            <h3>Arcade({date})</h3>
                            <button className='change' onClick={() => setCount(2)}>Change</button>
                        </div>
                        <div>
                            <h3>${tax}/{moYr}</h3>
                        </div>
